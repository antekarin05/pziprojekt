<?php
    ...
    if(!preg_match($regex_email,$email)){
        echo "Pogresan mail. Vracam vas na stranicu za registraciju";
        ?>
    ...
    if(strlen($password)<6){
        echo "Lozinka treba imati min. 6 znakova. Vracam  vas na stranicu za registraciju";
        ?>
        <meta http-equiv="refresh" content="2;url=signup.php" />
        <?php
    }
    ...
    if($rows_fetched>0){
        ...
        ?>
        <script>
            window.alert("Email vec registriran!");
        </script>
