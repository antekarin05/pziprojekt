        ...
        <div>
            ...
            <div class="container">
                <table class="table table-bordered table-striped">
                    <tbody>
                        <tr>
                            <th>Br.rezervacije </th><th>Ime rezervacije</th><th>Price</th><th></th>
                        </tr>
                       <?php 
                        $user_products_result=mysqli_query($con,$user_products_query) or die(mysqli_error($con));
                        $no_of_user_products= mysqli_num_rows($user_products_result);
                       ...
                       while($row=mysqli_fetch_array($user_products_result)){
                        ...
                        <tr>
                            ...
                            <th><a href='cart_remove.php?id=<?php echo $row['id'] ?>'>Izbrisi</a></th>
                        </tr>
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Ukupno</th><th>KM <?php echo $sum;?>/-</th><th><a href="success.php?id=<?php echo $user_id?>" class="btn btn-primary">Potvrdite narudzbu</a></th>
                        </tr>
                    </tbody>
                </table>
            </div>
